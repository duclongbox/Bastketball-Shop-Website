      ...
      {loading?(favShoeInfo.length!==0?(favShoeInfo.map((element,index)=>{
            ...
            <Modal isOpen={favorModal} className="bg-green-300">
              <div className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center ">
                ...
                <button onClick={()=>handelDelete(false,index)} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Unfollow
                </button>
                </div>
              </div>
          ...
          {loading?(buyShoeInfo.length!==0?(buyShoeInfo.map((element,index)=>{
            ...
            <Modal isOpen={openModal} className="bg-green-300">
              <div className="fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center ">
                ...
                <button onClick={()=>handelDelete(true,index)} className="mt-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                            Delete
                </button>
                </div>
              </div>
